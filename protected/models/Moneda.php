 ...
 * @property double $conversion_dolar
 *
...
class Moneda extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('conversion_dolar', 'numerical'),
            array('nombre', 'length', 'max'=>100),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, nombre, conversion_dolar', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'cotizacions' => array(self::HAS_MANY, 'Cotizacion', 'moneda_id'),
        );
    }
    ...
    public function search()
    {
            ...
            $criteria->compare('conversion_dolar',$this->conversion_dolar);
    ...
    public static function getDataForDropDownList() {
        ...
        $monedas = Moneda::model()->findAll($criteria);
        foreach($monedas as $datos) {
            $monedasData[$datos->id] = $datos->nombre;
        }
