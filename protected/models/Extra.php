...
class Extra extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            'arrivoCjcs' => array(self::MANY_MANY, 'ArrivoCjc', 'extra_arrivo(extra_id, arrivo_cjc_id)'),
            'salidaCjcs' => array(self::MANY_MANY, 'SalidaCjc', 'extra_salida(extra_id, salida_cjc_id)'),
            'servicios' => array(self::MANY_MANY, 'Servicio', 'extra_servicio(extra_id, servicio_id)'),
        );
    }
    ...
    public static function getDataForDropDownList() {
        ...
        foreach($extras as $datos) {
            $extrasData[$datos->id] = $datos->nombre;
        }
