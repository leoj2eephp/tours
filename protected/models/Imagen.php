...
class Imagen extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('ruta_imagen', 'required'),
            array('ruta_imagen', 'length', 'max'=>200),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, ruta_imagen', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'excursiones' => array(self::MANY_MANY, 'Excursion', 'imagen_excursion(imagen_id, excursion_id)'),
        );
    }
