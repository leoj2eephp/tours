...
class Lugar extends CActiveRecord {
	...
	public static function model($className=__CLASS__) {
        ...
        public function loadByTipoServicio($id) {
            $criteria = new CDbCriteria();
            $criteria->condition = 'tipo_servicio_id = :tipoServicioId';
            $criteria->params =array(":tipoServicioId"=>$id);
            return Lugar::model()->find($criteria);
        }
}