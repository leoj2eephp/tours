...
/**
 * This is the model class for table "salida_cjc".
 *
 * The followings are the available columns in table 'salida_cjc':
 * @property integer $id
 ...
 */
class SalidaCjc extends CActiveRecord {
    /**
    ...
    public function relations() {
        ...
        return array(
            'cotizacions' => array(self::HAS_MANY, 'Cotizacion', 'salida_cjc_id'),
            'extras' => array(self::MANY_MANY, 'Extra', 'extra_salida(salida_cjc_id, extra_id)'),
     ...
     * @return SalidaCjc the static model class
     */
