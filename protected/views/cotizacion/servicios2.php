...
<table class="form cotizacion" id="tablaServicios">
    ...
    <tr class="row" id="firstRow" index="0">
        ...
        <td><?php echo CHtml::activeTextField($model,'[0]n_personas',array('style'=>'width: 56px;')); ?></td>
        ...
        <td>
            <?php echo CHtml::activeDropDownList($model,'[0]lugar_id',array(),array('id'=>'lugarId_0','style'=>'width: 150px;')); ?>
        </td>
        ...
        <td><?php echo CHtml::activeTextField($model,'[0]valor',array('style'=>'width: 74px;')); ?></td>
